                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <h4 class="mb-0 text-white"><i class="fas fa-user"></i> &nbsp;&nbsp;&nbsp;Data Kelas Universitas Catur Insan Cendekia</h4>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table id="zero_config" class="table table-striped table-bordered no-wrap">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="<?php echo base_url().'index.php/Admin/Admin/data_kelas_mahasiswa/'.$kelas->id_kelas.'' ?>" class="btn btn-warning">Input Siswa</a>
                                                    <a href="<?php echo base_url().'index.php/Admin/Admin/data_kelas_mahasiswa_view/'.$kelas->id_kelas.'' ?>" class="btn btn-primary">View</a>
