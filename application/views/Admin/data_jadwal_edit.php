                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <h4 class="mb-0 text-white"><i class="fas fa-edit"></i> &nbsp;&nbsp;&nbsp;Form Update Data Jadwal Perkuliahan</h4>
                            </div>
                            <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-5">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" value="<?php echo $jadwal->ruangan ?>" name="ruangan">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
