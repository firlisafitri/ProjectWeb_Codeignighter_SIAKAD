                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <h4 class="mb-0 text-white"><i class="fas fa-user"></i> &nbsp;&nbsp;&nbsp;Data Absensi</h4>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table id="zero_config" class="table table-striped table-bordered no-wrap">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="<?php echo base_url().'index.php/Mahasiswa/Mahasiswa/data_absensi_view/'.$jadwal->id_jadwal.'' ?>" class="btn btn-info">View Absensi</a>
                                                </td>
                                            </tr>
                                        <?php } ?>
                                        </tbody>
