                                    ...
                                    <table id="zero_config" class="table table-striped table-bordered no-wrap">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="<?php echo base_url().'index.php/Dosen/Dosen/data_absensi_input/'.$jadwal->id_jadwal.'' ?>" class="btn btn-success">Input Absensi</a>
                                                    <a href="<?php echo base_url().'index.php/Dosen/Dosen/data_absensi_view/'.$jadwal->id_jadwal.'' ?>" class="btn btn-info">View Absensi</a>
                                                </td>
                                            </tr>
                                            <?php } ?>
                                        </tbody>
